...
## [1.0.2] - 2026-01-26
- Fix static analysis issues: Disable avoid_print rule for CLI generator tool
- Improve code formatting across all Dart files
- Update README.md installation instructions with specific version
- Ensure full compatibility with pub.dev quality standards
